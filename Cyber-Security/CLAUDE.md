...
# Cyber Security — Day-Job Professional Practice
...
- Never write actual malware, exploit code, or working attack tooling — this playbook covers defensive procedure and analysis methodology only.
- Never fabricate Columbia County-specific network details, IPs, configs, or policies Zac hasn't provided — flag as "fill in once you have real access" rather than guessing.
