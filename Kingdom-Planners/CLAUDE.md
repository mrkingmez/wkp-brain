...
|---|---|---|
| **Complete Budget System** | Ready | Flagship. 16 tabs: paycheck-style weekly budgeting (5 week blocks/month × 12 months), envelope system with auto-carryover, Debt Tracker fed from monthly actuals, adaptive Payoff Plan |
| **Debt Freedom Planner** | Ready | Real compound-interest amortization, Snowball/Avalanche toggle, 36-month schedule, chart |
| **PCS Moving Budget Planner** | Ready | DLA/TLE/mileage/per diem reimbursement calculator, Expense Tracker, 16-task Timeline Checklist |
| **Deployment Pay Budget Planner** | Ready | Special pays (Family Separation, Hazard/Imminent Danger, Hardship Duty), Home Budget While Deployed, savings tracker with chart |
| **VA Disability Claim Tracker** | Ready | Includes a real VA combined-rating calculator using whole-person math, not naive addition. Verified: 50%+10%+20% correctly combines to 64%, rounds to 60%. **Genuine differentiator vs. competitors** |
| **Terminal Leave / ETS Transition Planner** | Ready | Terminal leave payout calculator, 6-month transition budget, months-of-runway calculation |
| **Road Trip Planner & Tracker** | Ready | Trip budget with pie chart, 20-stop Lodging Planner, 20-stop Stops & Attractions (kept separate per Zac's spec), 20-entry Fill-Up Tracker, business mileage deduction at current IRS rate (76¢/mile as of July 2026, editable) |
| Budget-Envelope-Debt-Tracker | Superseded | Complete Budget System replaced it. Could become a cheaper "lite" tier, or retire it |

All files are Excel-native. **A Google Sheets compatibility pass has not been run yet** — formulas were chosen to work in both, but nobody has actually opened them in Sheets. Do this before listing.

## Pricing
- Etsy fee model: ~9.5% of sale price + $0.45 (6.5% transaction + ~3%+$0.25 processing + $0.20 listing)
- Debt Freedom Planner: **$12**
- Complete Budget System: **$19**
- PCS, Deployment, VA Tracker, Terminal Leave, Road Trip: **not yet priced** — need the same competitor-research treatment before listing
- Bundle concept: "Military Family Complete System" — all 6 military-relevant planners zipped into one listing. Price not set.
- Cross-sell mechanism: Etsy doesn't support merged bundle listings across formats. Use a **discount coupon code** (e.g. `BUNDLE10`) cross-promoted in each listing description instead.
...
- **Open research question:** how Etsy's AI-disclosure requirement applies here. These aren't AI-*generated content* the way WKD art is — they're original tools built with AI assistance. Confirm the actual Etsy policy language rather than assuming either way.

**Per-listing work (not started for any of the 7):**
- Titles, 13 tags, and descriptions for every product
- Listing photos / mockup screenshots
- Individual pricing for the 5 unpriced products
- Military Family bundle price
...
[FILL IN — Google Sheets compatibility test results]
[FILL IN — logo v2 final]
[FILL IN — local path for the .xlsx product files — add to LOCAL-PATHS.md]